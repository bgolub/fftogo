...
urlpatterns = patterns('',
    ...
    url(r'^groups/(?P<nickname>[\w-]+)/$', 'fftogo.views.room', name='room'),
    url(r'^groups/$', 'fftogo.views.rooms', name='rooms'),
    url(r'^rooms/(?P<nickname>[\w-]+)/$', 'fftogo.views.room'),
    url(r'^rooms/$', 'fftogo.views.rooms'),
    url(r'^list/(?P<nickname>[\w-]+)/$', 'fftogo.views.list', name='list'),
    url(r'^lists/(?P<nickname>[\w-]+)/$', 'fftogo.views.list'),
    ...
    url(r'^related/$', 'fftogo.views.related', name='related'),
    url(r'^(?P<nickname>[\w-]+)/$', 'fftogo.views.user', name='user'),
    url(r'^(?P<nickname>\w+)/subscribe/$', 'fftogo.views.user_subscribe', name='user_subscribe'),
    url(r'^(?P<nickname>\w+)/unsubscribe/$', 'fftogo.views.user_unsubscribe', name='user_unsubscribe'),
